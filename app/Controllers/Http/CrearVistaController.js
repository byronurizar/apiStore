...
class CrearVistaController {
    async crearVistas({ auth, response }) {
        ...
        try {
            ...
            AS
            select a.id,a.nombre,a.descripcion,a.descripcionCorta,a.precio,a.oferta,Concat(b.pathImagen,b.codigoImagen) as pathImagen,b.esImagenPrincipal  from productos a
